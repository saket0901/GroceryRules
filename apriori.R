...
library(arules)
getwd()
groceries <- read.transactions("C:/Users/saket/Downloads/groceries.csv",
                               sep = ",")
groceries
#it results in a sparse matrix suitable for
#transactional data.
summary(groceries) 
#details about no of transactions, no of items,
#density of non zero,
inspect(groceries[1:5])
#provide the detail of first 5 transactions
itemFrequency(groceries[, 1:3])
#allows us to see the proportion of transactions that
#contain the item and to view the support level for
...
#plot with 20 items
image(groceries[1:5])
#visualize the sparse matrix including 5 transactions and 169
#items. cell will be black where transaction
#is done 
image(sample(groceries, 100))
#combining it with the sample() function, you can
